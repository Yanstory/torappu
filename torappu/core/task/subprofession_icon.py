...
BASE_DIR = STORAGE_DIR.joinpath("asset", "raw", "subprofession_icon")


class SubProfessionIcon(Task):
    ...
    def check(self, diff_list: list[Diff]) -> bool:
        ...
        self.ab_list = {
            ...
            if asset.startswith("arts/ui/subprofessionicon") and bundle in diff_set
        }
